...
public class WelcomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.temp_activity_welcome);
        ...
        layouts = new int[]{
                R.layout.temp_welcome_slide1,
                R.layout.temp_welcome_slide2,
                R.layout.temp_welcome_slide3,
                R.layout.temp_welcome_slide4};
    ...
    private void launchHomeScreen() {
        ...
        if (uname != null) {
            ...
            handleIntent = new Intent(WelcomeActivity.this, Main2Activity.class);
            startActivity(handleIntent);
        }else{
            handleIntent = new Intent(WelcomeActivity.this, Login2Activity.class);
            startActivity(handleIntent);
        }
        finish();
    }

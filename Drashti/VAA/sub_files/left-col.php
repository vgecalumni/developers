<div id="left-col-container">
	...
	<?php
$q='SELECT DISTINCT `reciver_name`,`sender_name`FROM `admin_chat` WHERE `sender_name`="'.$_SESSION['username'].'" OR `reciver_name`="'.$_SESSION['username'].'" ORDER BY `datetime` DESC';

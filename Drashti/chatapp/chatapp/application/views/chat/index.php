  ...
  <tr>
    ...
    <td>
      <div id="chat_input">
        ...
        <?php echo anchor('#', 'Send', array('title' => 'Send this chat message', 'id' => 'submit_message', 'class' => 'btn btn-default btn-sm')); ?>
    ...
    <td>
      <?php
        ...
        if ($video == 0) {
            echo '<input type="submit" name="submit_video" value="Video Calls"
              class="btn btn-info btn-sm" />';
        } else {
            echo '<input type="submit" name="submit_close_video" value="Video Calls"
              class="btn btn-danger btn-sm" />';
        }

        if ($audio == 0) {
            echo ' <input type="submit" name="submit_audio" value="Voice Calls"
              class="btn btn-info btn-sm" />';
        } else {
            echo ' <input type="submit" name="submit_close_audio" value="Voice Calls"
              class="btn btn-danger btn-sm" />';
        }
      ?>

<style type="text/css">
.custom_btn a{background-color:transparent;-webkit-text-decoration-skip:objects;}
.custom_btn a:active,.custom_btn a:hover{outline-width:0;}
::-webkit-input-placeholder{color:inherit;opacity:0.54;}
.custom_btn a{color:inherit;}
.w3-btn{margin:10px;border:none;display:inline-block;padding:8px 16px;vertical-align:middle;overflow:hidden;text-decoration:none;color:inherit;background-color:inherit;text-align:center;cursor:pointer;white-space:nowrap;}
...
.custom_btn a:hover,.custom_btn a:active{color:#4CAF50;}

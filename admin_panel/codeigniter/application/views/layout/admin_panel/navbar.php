        ...
        <ul class="navbar-nav navbar-nav-right">
          ...
          <li class="nav-item dropdown d-none d-xl-inline-block">
            <a class="nav-link dropdown-toggle" id="UserDropdown" href="#" data-toggle="dropdown" aria-expanded="false" style="padding: 5px;border-radius: 10px;">
              <span class="profile-text">Hello, <?php echo $user_name; ?></span>
              <img class="img-xs rounded-circle" src="<?php echo $pic; ?>" alt="Profile image">
            </a>
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
              ...
              <a class="dropdown-item" href="<?php echo base_url().'main/logout';?>">
                Sign Out
              </a>
            </div>
          </li>

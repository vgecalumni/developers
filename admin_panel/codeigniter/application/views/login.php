         ...
         <div class="container">
             <div class="row">
                 <div class="col-sm-4 login-box">
                     ...
                     <div class="row">
                         <input type="text" name="email" placeholder="Email" class="form-control inpt-sm">
                     </div>
                     <div class="row">
                         <input type="password" name="password" placeholder="Password" class="form-control inpt-sm">
                     </div>
                     <div class="row chk-lab">
                        ...
                        <div class="col-sm-6 colkd">
                            <a href="<?php echo base_url().'main/ForgetPassword';?>">Forget Password ?</a>
                        </div>
                     </div>
                     <?php
                        echo $this->session->flashdata("error");

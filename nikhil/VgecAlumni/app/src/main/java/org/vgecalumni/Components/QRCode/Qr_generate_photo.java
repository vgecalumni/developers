...
public class Qr_generate_photo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RegEventResponsecall.enqueue(new Callback<RegEventResponse>() {
            ...
            public void onResponse(Call<RegEventResponse> call, Response<RegEventResponse> response) {
                ...
                if (regEventResponse.isError()) {
                    ...
                    if(s_photo.equals("0")){
                        ...
                        desc.setText("Your photo coupon has been generated for " +s_event + " ! To take photograph with frame, you have to just verify this coupon at A-Block on the event day !");
            ...
            public void onFailure(Call<RegEventResponse> call, Throwable t) {
                ...
                Intent generateFoodIntent = new Intent(Qr_generate_photo.this, OfflineActivity.class);
    ...
    private void endProgress() {
        Toast.makeText(Qr_generate_photo.this, "try again!", Toast.LENGTH_SHORT).show();
